...
| `prompts/roles/`, `mcp/lib/role-model.js` | `prompts/roles/` and `mcp/lib/role-model.js` define shared role contracts that adapters render into host-specific files. |

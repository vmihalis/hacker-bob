...
// The Kimi adapter installs the session-guard PreToolUse hooks under
// <target>/.kimi/hooks/ and registers them in ~/.kimi/config.toml as a
// sentinel-fenced [[hooks]] array-of-tables block. The install/registration
// wiring (HOOK_FILES, EXECUTABLE_HOOKS, and the upsertKimiHookBlock /
// renderKimiHookBlock TOML helpers) lives in adapters/kimi/index.js.
// Registration is best-effort and merge-not-clobber, so operator hooks and

...
const { appendCellProposal, readCellProposals } = require("../task-graph-events.js");
const { cellNodeId, materializeTaskGraph } = require("../task-graph-materializer.js");
const { appendContract } = require("../contracts.js");
const { buildCellCoverageContract } = require("../cell-contract.js");
...
function handler(args) {
  ...
  const { planCellsForSurface, enumerateTransitionCellFloor } = require("../assignment-brief.js");
  ...
  const { logCellCoverage } = require("../coverage.js");
  ...
  if (policy.residual_depth_reprobe_enabled === true) {
    try {
      const { deriveResidualDepthReprobes } = require("../belief/residual-depth.js");

...
const { pushUnique } = require("../io/validation.js");
const { compactSessionState } = require("../session/session-state-contracts.js");
const { readAttackSurfaceStrict } = require("../frontier/attack-surface.js");
const { previewSurfaceLeadPromotion } = require("../frontier/surface-leads.js");
const { rankAttackSurfaces } = require("../ranking.js");
const { computeCoverageRequeueSurfaceIds } = require("../frontier/coverage.js");
const {

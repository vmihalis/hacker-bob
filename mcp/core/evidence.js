...
function pipelineEventsLib() {
  return require("./telemetry/pipeline-events.js");
}
...
function normalizeEvidencePacksDocument(document, {
  ...
  const capabilityPackProjection = require("./capability/capability-pack-evidence-adapters.js")
...
function assertEvidenceCompletenessForFreeze(domain, { suppliedRefs = null } = {}) {
  ...
  const { assertCompletenessAgainstFreeze } = require("./claims/claim-freeze.js");

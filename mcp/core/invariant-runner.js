...
const { ERROR_CODES } = require("./io/envelope.js");
  ...
  if (dry_run !== true) {
    ...
    if (isSealedCrossStack) {
      ...
      forkUrlsForRun = (Number.isInteger(chain_id) && chain_id > 0)
        ? require("../domains/blockchain/smart-contracts/evm-rpc-pool.js").resolveEvmRpcEndpoints(chain_id)
        : [];
    ...
    if (!tbError && tbResult && typeof tbResult.address === "string" && typeof tbResult.code_sha256 === "string") {
      ...
      if (chain_id != null && fork_block != null) {
        try {
          const { ethGetCodeAgreed } = require("../domains/blockchain/smart-contracts/evm-client.js");

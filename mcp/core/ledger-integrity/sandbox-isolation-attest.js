...
function probeSigningKeyIsolation(domain) {
  const { handoffSigningKeyPath } = require("../io/paths.js");
...
function probeVerdictLedgerKeyIsolation(domain) {
  const { handoffSigningPrivateKeyPath } = require("../io/paths.js");
...
function recordSandboxIsolationAttestation(domain) {
  const { sandboxIsolationPath } = require("../io/paths.js");
  const { writeFileAtomic } = require("../io/storage.js");

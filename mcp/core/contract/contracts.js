...
function getToolHandlers() {
  if (_toolHandlersCache == null) {
    _toolHandlersCache = require("../dispatch/tool-registry.js").TOOL_HANDLERS;
  }
...
function defaultLookupNodeState(targetDomain, nodeId) {
  if (_materializeTaskGraphCache == null) {
    _materializeTaskGraphCache = require("../waves/task-graph-materializer.js").materializeTaskGraph;
  }

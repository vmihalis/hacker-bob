...
function violatedArmConsumedCause(violatedLeg, controlLeg, causeLeg, opts = {}) {
  ...
  if (opts.refetchCause === true) {
    ...
    try {
      ...
      const { readOffensiveCaptureBytesSecure } = require("../claims/claim-freeze.js");
...
function decoyShapeMatchesCause(decoyCaptureLeg, causeLeg, opts = {}) {
  ...
  try {
    // eslint-disable-next-line global-require
    ({ readOffensiveCaptureBytesSecure: readBytes } = require("../claims/claim-freeze.js"));
    // eslint-disable-next-line global-require
    ({ classifyConsumableShape: classify } = require("../verification/consumable-shape.js"));
  } catch {

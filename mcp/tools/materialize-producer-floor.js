...
const { materializeTaskGraph, producerNodeId } = require("../core/waves/task-graph-materializer.js");
const { loadQueuePolicy, CLAMP_CEILING } = require("../core/io/queue-policy.js");
const { httpAuditJsonlPath, statePath, trafficJsonlPath } = require("../core/io/paths.js");
const { readFileUtf8, readJsonFile, withSessionLock } = require("../core/io/storage.js");
...
function loadTransitionSurfaceId() {
  const { transitionSurfaceId } = require("../core/frontier/frontier-materializer.js");
...
function planCompositionFloor({
  ...
  const kindValues = transitionKindValues || require("../core/waves/task-graph-events.js").TRANSITION_KIND_VALUES;

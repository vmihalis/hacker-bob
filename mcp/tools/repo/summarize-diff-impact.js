...
const fs = require("fs");
const { parseUnifiedDiff } = require("../../domains/repo/unified-diff-parser.js");
const { summarizeImpactedSurfacesForDiff } = require("../../domains/repo/symbol-surface-index.js");
const { assertSafeDomain, diffImpactPath, sessionDir } = require("../../core/io/paths.js");
const { withSessionLock, writeFileAtomic } = require("../../core/io/storage.js");

...
test("STIGMERGIC_PRODUCERS contains exactly the 17 canonical Y-D19 + Plane-Delta S12/PR4/I10/I12 + Plane-B CB-S1/CB-1/CB-2/CB-3/CB-B1/CB-B4/CB-B6 entries", () => {
  assert.equal(STIGMERGIC_PRODUCERS.length, 17);
